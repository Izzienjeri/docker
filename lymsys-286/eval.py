import unittest
from solution import convert_hex_to_required
...
class Test(unittest.TestCase):
    ...
    def test_invalid_hex_input(self):
        ...
        with self.assertRaises(ValueError):
            convert_hex_to_required('g', 'decimal')
        with self.assertRaises(ValueError):
            convert_hex_to_required('', 'decimal')  
        with self.assertRaises(ValueError):
            convert_hex_to_required('0x 1', 'decimal')  
    ...
    def test_zero_input(self):
        self.assertEqual(convert_hex_to_required('0', 'decimal'), '0')
        self.assertEqual(convert_hex_to_required('0', 'binary'), '0')
        self.assertEqual(convert_hex_to_required('0', 'octal'), '0')
